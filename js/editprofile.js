...
function editValue() {
    ...
    $.ajax({
        ...
        success: function (user) {
            lastLoginStamp = user.lastLoginStamp;
            console.log(user.dateOfBirth);
            console.log(user.firstName, user.middleName);
            ...
            if (user.gender == null) {
                ...
                for (let index = 1; index < gender.length; index++) {
                    // const element = array[index];
                    console.log(gender[index].value);
                    if (gender[index].value == user.gender) {
                        document.getElementById('gender').selectedIndex = index;
            ...
            if (user.country == null) {
                ...
                for (let index = 0; index < country.length; index++) {
                    // const element = array[index];
                    console.log(country[index].value);
                    if (country[index].value == user.country) {
            ...
            if (user.phoneExt != null) {
                document.getElementById('phoneExt').value = user.phoneExt;
            ...
            if (user.role == null) {
                ...
                document.getElementById('role').value = user.userName;
                for (let index = 0; index < role.length; index++) {
                    // const element = array[index];
                    console.log(role[index].value);
                    if (role[index].value == user.role) {
